# HICO - Hierarchical In-Context Organization

Project for the course of Natural Language Processing.

Built on the work *"ICLR: In-Context Learning of Representations"*[1].

For a detailed description of the project, please refer to the [project report](./doc/Report.pdf).
