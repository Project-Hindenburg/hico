...
if __name__ == "__main__":
    ...
    generate_dataset(tree, context_tokens=3000, output_path=f"{DATA_DIR}/one_random_walk/tree_numbers/bin_tree_one_rw_3000.txt")
    ...
    generate_dataset(shuffled_tree, context_tokens=3000, output_path=f"{DATA_DIR}/one_random_walk/shuffled_tree_numbers/bin_tree_numbers_shuffled_one_rw_3000.txt")
    ...
    generate_dataset(only_leaves_tree, context_tokens=3000, output_path=f"{DATA_DIR}/one_random_walk/only_leaves_tree/tree_only_leaves_one_rw_3000.txt")
    ...
    generate_dataset(only_leaves_ordered_tree, context_tokens=3000, output_path=f"{DATA_DIR}/one_random_walk/only_leaves_ordered_tree/tree_only_leaves_one_rw_3000.txt")
    ...
    generate_dataset(grid, context_tokens=3000, output_path=f"{DATA_DIR}/one_random_walk/grid_numbers/grid_numbers_one_rw_3000.txt")
    ...
    generate_dataset(shuffled_grid, context_tokens=3000, output_path=f"{DATA_DIR}/one_random_walk/shuffled_grid_numbers/grid_numbers_shuffled_one_rw_3000.txt")
    ...
    generate_dataset(circle, context_tokens=3000, output_path=f"{DATA_DIR}/one_random_walk/circle_numbers/circle_numbers_one_rw_3000.txt")
    ...
    generate_dataset(shuffled_circle, context_tokens=3000, output_path=f"{DATA_DIR}/one_random_walk/shuffled_circle_numbers/circle_numbers_shuffled_one_rw_3000.txt")
    ...
    generate_dataset(tree, context_tokens=3000, output_path=f"{DATA_DIR}/one_random_walk/tree_days/bin_tree_days_dataset_3000.txt")
    ...
    generate_dataset(circle, context_tokens=3000, output_path=f"{DATA_DIR}/one_random_walk/circle_days/circle_days_one_rw_3000.txt")
    ...
    generate_dataset(shuffled_circle, context_tokens=3000, output_path=f"{DATA_DIR}/one_random_walk/shuffled_circle_days/circle_days_shuffled_one_rw_3000.txt")
